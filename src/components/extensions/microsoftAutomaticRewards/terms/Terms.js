...
<div className="terms">
    ...
    <p>This app, <strong>Microsoft Automatic Rewards</strong>, is a third-party utility designed to automate Bing searches for users participating in the Microsoft Rewards program.</p>

    <h2 className="titles">1. Information We Collect</h2>
    <p>We do <strong>not</strong> collect, store, or transmit any personally identifiable information (PII) from users.</p>

    <h2 className="titles">2. How the App Works</h2>
    <p>The app opens Bing search tabs automatically based on preconfigured or randomized queries. It operates locally on the device and does not interact with any external servers or APIs, other than opening bing.com via the default browser.</p>

    <h2 className="titles">3. Data Usage</h2>
    <ul>
        <li>No search terms, cookies, or user data are collected or stored.</li>
        <li>The app does not access or transmit Microsoft account information.</li>
    ...
    <p>If you have any questions or concerns about this Privacy Policy, please contact us at: <a href="mailto:spin311pro@gmail.com">spin311pro@gmail.com</a></p>
</div>
    );
}
