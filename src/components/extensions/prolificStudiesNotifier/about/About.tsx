...
function About() {
  ...
  return (
    <div id="about">
      ...
      <p>{text.PROLIFIC.description}</p>
      <div className="to-work">
        <div className="about-text">
          <h3>{text.PROLIFIC.to_work}</h3>
          <ul className="to-work-list">
            <li className="underline-link">
              {formatHtml(`${text.PROLIFIC.step1}`)}
            </li>
            <li>
              {text.PROLIFIC.step2} <ImageTooltip src="enableGoogle2.png" />
            </li>
            <li>
              {text.PROLIFIC.step3} <ImageTooltip src="enableWindows2.png" />
            </li>
          </ul>
        </div>
