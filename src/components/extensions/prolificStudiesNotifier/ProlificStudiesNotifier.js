...
function ProlificStudiesNotifier() {
    ...
    let links = [
        {href: "https://chromewebstore.google.com/detail/prolific-studies-notifier/mlicfddkgjkeajfgkihplfbgpmbonbao", text: text.PROJECT.download, icon: faArrowDown, link: true},
        {href: "https://github.com/spin311/ProlificAutomaticStudies", text: "GitHub", icon: faGithub, link: true, internal: false},
        {href: "/donate", text: text.GENERAL.donate, icon: faDonate, link: false, internal: true},
    ];
    const image={src: "assets/images/prolific.png", alt: "Prolific Studies Notifier"};
    return (
        <>
            <Helmet>
                <title>Prolific Studies Notifier</title>
                <meta name="description" content="Prolific Studies Notifier browser extension" />
            </Helmet>
            <div className="App">
                <SidebarMenu className="SidebarMenu" sections={prolificSections} />
